...
func main() {
	...
	loghlp.Debugf("trframe hall_server start")
	...
	trframe.Init(cfgPath, trnode.ETRNodeTypeHallServer, servIdx)
	hallServ := hallserver.NewHallServer()
