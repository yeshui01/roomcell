...
func (x *RoomPlayerData) GetRoleID() int64 {
	if x != nil {
		return x.RoleID
	}
	return 0
...
func (x *RoomPlayerData) GetNickname() string {
	if x != nil {
		return x.Nickname
	}
	return ""
...
var file_s_common_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x4e, 0x6f, 0x64, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x44, 0x0a, 0x0e, 0x52,
	0x6f, 0x6f, 0x6d, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x12, 0x16, 0x0a,
	...
	0x65, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x70, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x62,
...
var file_s_common_proto_goTypes = []interface{}{
	...
	(*RoomPlayerData)(nil), // 2: pbserver.RoomPlayerData
}
